        ...
        const validateField = (input) => {
            ...
            if (input.hasAttribute('pattern') && value) {
                ...
                if (!pattern.test(value)) {
                    showError(input, input.getAttribute('data-pattern-error') || 'Please match the requested format');
                    return false;
                }
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'dcdc7c64-6bb5-461f-983f-bf4d5c02c3a1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'dcdc7c64-6bb5-461f-983f-bf4d5c02c3a1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dcdc7c64-6bb5-461f-983f-bf4d5c02c3a1';
